...
#define rtc_get_ticks() (HAL_GetTick())


#define ATOMIC(x) 	/* Disable interrupts */ __disable_irq(); x  /* Enable interrupts back */ __enable_irq();
...
#else
	typedef void ( * sch_cb_func_t)(uint8_t *);
#endif // not _SDCC_
