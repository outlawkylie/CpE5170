...
extern rtc_tick_t		sch_timeout_ticks[MAX_TIMEOUTS];
extern uint8_t			sch_timeout_state[MAX_TIMEOUTS];
extern list_size_t		sch_timeout_count;

extern list_index_t		sch_timeout_order[MAX_TIMEOUTS];
extern list_index_t		sch_tout_head;
extern list_index_t		sch_tout_free;
extern sch_cb_func_t	sch_callback_funcs[MAX_TIMEOUTS];
